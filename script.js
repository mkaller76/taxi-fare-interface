let taxiFareApiUrl = 'https://taxifare-1082554174077.europe-west1.run.app/predict'; // replace with your API endpoint
const centralCoordinates = [-74.00597, 40.71427]; // starting position [lng, lat]

if (window.location.href.includes('https://mkaller76.github.io/taxi-fare-interface/')) {
  taxiFareApiUrl = 'https://taxifare-1082554174077.europe-west1.run.app/predict';
}
